...
以“任意上传企业资料”为入口，自动完成文档解析、知识抽取、模块归类和来源留证；覆盖企业核心定位、装修行业通用知识、企业独有流程与标准、AI 动态扩展模块、冲突选择和版本发布。对话节奏与通用销售技巧不进入企业大脑。

## 案例与数据说明

视频、企微和召回页面仍以 AKKE 专题案例与评审模拟内容为主；企业大脑已于 2026-08-02 改为生产数据支持的脱敏原型：67 份企业知识文档、362 条行业知识索引和 2,987 个检索片段用于页面结构与内容填充。

企业大脑公开页只包含适合团队评审的业务事实、统计和行业知识摘要。私人销售对话原文、完整门店地址、数据库密钥以及受限原文件不会写入仓库。206 段历史销售对话和 36 条决策规则只显示隔离状态与数量，不作为企业事实直接发布。
